...
const ShareModal = ({ isOpen, onClose, productName, productId }) => {
  ...
  const handleTwitterShare = () => {
    const twitterText = `Check out ${productName}`;
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-gray-800">Share Product</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-3">
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="font-semibold text-gray-800">Share on WhatsApp</p>
                <p className="text-xs text-gray-500">Send to friends and family</p>
              </div>
            </button>
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="font-semibold text-gray-800">Share on Facebook</p>
            ...
            >
              ...
              <div className="flex-1 text-left">
                <p className="font-semibold text-gray-800">Share on Twitter</p>
                <p className="text-xs text-gray-500">Tweet to your followers</p>
              </div>
            </button>
            ...
            {navigator.share && (
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <p className="font-semibold text-gray-800">More Options</p>
                  <p className="text-xs text-gray-500">Share via other apps</p>
                </div>
              </button>
            )}
          </div>
